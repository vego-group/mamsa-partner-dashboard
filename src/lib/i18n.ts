...
export const dict: Record<Locale, Dict> = {
  ar: {
    ...
    pricing: {
      ...
      priceHelper:
        "هذا هو المبلغ الذي يدفعه الضيف شاملًا ضريبة القيمة المضافة. تُفصَل الضريبة (15%) أولًا، ثم تُحتسب عمولة المنصة (10%) من المبلغ المتبقي قبل الضريبة، لا من السعر الكامل.",
  ...
  en: {
    ...
    reports: {
      ...
      commission: "Mamsa Commission (10%)",
    ...
    pricing: {
      ...
      priceHelper:
        "This is the amount the guest pays, VAT included. VAT (15%) is separated out first, and the platform commission (10%) applies to the remaining pre-VAT amount — not to the full price.",
